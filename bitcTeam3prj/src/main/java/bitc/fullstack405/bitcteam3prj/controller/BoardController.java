...
public class BoardController {
    ...
    public ModelAndView selectBoardList(
        ...
        List<BoardEntity> noticeList = null;
        ...
        if(searchCateNullChk && searchTitleNullChk){
            ...
            noticeList = boardService.selectNoticeList();
        }
...
//    게시글 등록 처리
    ...
    public String insertBoard(
        ...
        if(option != null && !option.isEmpty() && !option.equals(BoardCategory.CATE_1.getDescription())) {
