...
public interface BoardRepository extends JpaRepository<BoardEntity, Long> {
    ...
    List<BoardEntity> findTop3ByCategoryContainsOrderByCreatedAtDesc(String category);

    Page<BoardEntity> findAllByCategoryNotContains(Pageable pageable, String category);
